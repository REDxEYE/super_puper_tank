...
public class BloodParticleController implements IParticleController {
    ...
    public IParticle createParticle(Vector2 position) {
        ...
        DecayingParticle newParticle = new DecayingParticle(position, radius, 8 + rand.random(-2, 2),20.f, Colors.Blood);
