...
public class BulletMortar extends Bullet {
    public BulletMortar(float x, float y, float rotation, float damage, float penetration, float damage_fragment, float penetration_fragment, byte type_time, byte height){
        this.x = x;this.y = y;
