...
import com.mygdx.game.content.Block.Air;
import com.mygdx.game.content.Block.BlockMap;
import com.mygdx.game.content.Soldat.SoldatBull;
import com.mygdx.game.content.Soldat.SoldatRegister;
import com.mygdx.game.content.Transport.Transport.PanzerFlameT1;
import com.mygdx.game.content.particle.*;
import com.mygdx.game.data.DataImage;
import com.mygdx.game.data.DataSound;
...
import com.mygdx.game.content.particle.AcidParticleController;
import com.mygdx.game.particle.ParticleV1;
import com.mygdx.game.soldat.Soldat;
import com.mygdx.game.transport.AI;
...
import com.mygdx.game.transport.TransportRegister;
...
public class Main extends ApplicationAdapter {
    ...
    public static LinkedList<ParticleV1> FlameStaticList = new LinkedList<>();
    public static ArrayList<Button> ButtonList = new ArrayList<>();
    public static LinkedList<ParticleV1> FlameList = new LinkedList<>();
    public static ArrayList<Soldat> SoldatList = new ArrayList<>();
    public static LinkedList<ParticleV1> BangList = new LinkedList<>();
    public static LinkedList<ParticleV1> FlameParticleList = new LinkedList<>();
    public static AcidParticleController acidParticleController = new AcidParticleController();
    public static BloodParticleController bloodParticleController = new BloodParticleController();

    public static LinkedList<ParticleV1> LiquidList = new LinkedList<>();
    public static LinkedList<ParticleV1> FlameSpawnList = new LinkedList<>();
    ...
    public static com.mygdx.game.content.Soldat.SoldatRegister SoldatRegister;
...
//		EnemyList.add(new PanzerFlameT1(2200,2000,Main.EnemyList));
        ...
        LiquidList.add(new AcidParticle(new Vector2(200, 200), 24 + rand.rand(8),8.f));
        LiquidList.add(new BloodParticle(new Vector2(200, 200), 24 + rand.rand(8),8.f));
    ...
    public void field(int width_field, int height_field) {
        ...
        LiquidList.add(new AcidParticle(new Vector2(200, 200), 24 + rand.rand(8),8.f));
        LiquidList.add(new BloodParticle(new Vector2(200, 200), 16 + rand.rand(8),8.f));
        FlameSpawnList.add(new FlameSpawn(200, 200));
        FlameStaticList.add(new FlameStatic(200, 200));
        BangList.add(new Bang(200, 200, 10));
    }
