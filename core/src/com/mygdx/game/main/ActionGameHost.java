            ...
            try {
                if (timer <= 0) {
                    ...
                    if (Keyboard.LeftMouse) {
                        ...
                        timer = 30;
                        Main.bulletList.add(new BulletFragment(Keyboard.MouseX / Zoom + RC.x2, Keyboard.MouseY / Zoom + RC.y2, 40, 20, (byte) 1));
                        Main.bulletList.add(new BulletFragment(Keyboard.MouseX / Zoom + RC.x2, Keyboard.MouseY / Zoom + RC.y2, 40, 20, (byte) 1));
                        Main.bulletList.add(new BulletFragment(Keyboard.MouseX / Zoom + RC.x2, Keyboard.MouseY / Zoom + RC.y2, 40, 20, (byte) 1));
                        Main.bulletList.add(new BulletFragment(Keyboard.MouseX / Zoom + RC.x2, Keyboard.MouseY / Zoom + RC.y2, 40, 20, (byte) 1));
                        Main.bulletList.add(new BulletFragment(Keyboard.MouseX / Zoom + RC.x2, Keyboard.MouseY / Zoom + RC.y2, 40, 20, (byte) 1));
                    ...
                    if (Keyboard.RightMouse) {
                        ...
                        Main.LiquidList.add(new AcidParticle(mousePos, 24 + rand.rand(8),8.f));
